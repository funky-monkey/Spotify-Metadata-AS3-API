...
package com.spotify.api.vo {
	 ...
	 */
	final public class TrackSearchVO {

		public var track_id : String = "No value set";
		public var track_name : String = "No value set";
		public var artist : ArtistVO;
		public var id_type : String = "No value set";
		public var id_value : String = "No value set";
		public var album : AlbumVO;
		public var track_number : String = "No value set";
		public var track_length : String = "No value set";
		public var popularity : String = "No value set";
	}
}