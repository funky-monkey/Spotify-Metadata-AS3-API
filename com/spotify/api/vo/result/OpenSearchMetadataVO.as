...
package com.spotify.api.vo.result {
	...
	final public class OpenSearchMetadataVO {
		...
		public var role : String = "No value set";
		public var startPage : String = "No value set";
		public var searchTerms : String = "No value set";
		public var totalResults : String = "No value set";
		public var startIndex : String = "No value set";
		public var itemsPerPage : String = "No value set";
	}
}
